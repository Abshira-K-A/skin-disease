...
class ScheduleRoutinePage extends StatefulWidget {
  const ScheduleRoutinePage({Key? key, required String userId}) : super(key: key);
...
class _ScheduleRoutinePageState extends State<ScheduleRoutinePage> {
  ...
  Future<void> _scheduleNotification() async {
    ...
    await NotificationService.scheduleDailyNotification(
      ...
      body: 'Time to follow your skincare routine!',
      time: _selectedTime!,
    );

    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("Reminder set for ${_selectedTime!.format(context)}")),
    );
  }

  Future<void> _testNotification() async {
    await NotificationService().showNotificationFromPayload({
      'title': '🧴 Test Notification',
      'body': 'This is a test skincare routine reminder!',
    });
  }
