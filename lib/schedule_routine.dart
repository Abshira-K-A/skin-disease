...
//     // Schedule new notifications with unique IDs
//     if (_routineFrequency == 'Morning only' || _routineFrequency == 'Both') {
//       await NotificationService.scheduleDailyNotification(
//         id: _generateNotificationId('morning'), // Unique ID for morning
//         title: "🌞 Time for your morning skincare routine!",
...
//       await NotificationService.scheduleDailyNotification(
//         id: _generateNotificationId('evening'), // Unique ID for evening
//         title: "🌙 Time for your evening skincare routine!",
//         body: "Don't forget to use: ${_selectedProducts.join(', ')}",
//         time: _eveningTime,
...
//               ? "Routine updated successfully! Reminders set."
//               : "Routine created successfully! Reminders set.",
//         ),
...
// // Helper method to generate consistent notification IDs
// int _generateNotificationId(String type) {
//   // Creates unique IDs based on type and user ID hash
//   final userIdHash = widget.userId.hashCode;
//   return type == 'morning' 
//       ? userIdHash % 10000 + 1000  // Morning IDs in 1000-1999 range
//       : userIdHash % 10000 + 2000; // Evening IDs in 2000-2999 range
// }
  ...
  Future<void> _saveRoutine() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'products': _selectedProducts,
        'frequency': _routineFrequency,
        'specific_days': _enableSpecificDays 
            ? _selectedDays.map((day) => Timestamp.fromDate(day)).toList()
            : null,
        'created_at': Timestamp.now(),
        'status': 'active',
      });
      ...
      if (_routineFrequency == 'Morning only' || _routineFrequency == 'Both') {
        await NotificationService.scheduleDailyNotification(
          id: _generateNotificationId('morning'),
          title: "🌞 Time for your morning skincare routine!",
          body: "Don't forget to use: ${_selectedProducts.join(', ')}",
          time: _morningTime,
          payload: 'morning_routine',
          specificDate: _enableSpecificDays ? _selectedDays.first : null,
        );
      }

      if (_routineFrequency == 'Evening only' || _routineFrequency == 'Both') {
        await NotificationService.scheduleDailyNotification(
          id: _generateNotificationId('evening'),
          title: "🌙 Time for your evening skincare routine!",
          body: "Don't forget to use: ${_selectedProducts.join(', ')}",
          time: _eveningTime,
          payload: 'evening_routine',
